...
import type { DeviceHints, DeviceInfo, ResolvedHttpClientHintsOptions } from './types'
...
export const DeviceHintsHeaders = Array.from(Object.values(DeviceClientHintsHeaders)).concat('user-agent')
